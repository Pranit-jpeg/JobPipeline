"""
American Enterprise Institute (AEI) scraper — iCIMS portal (Playwright).
Same pattern as Brookings since both use iCIMS.
"""
...
SEARCH_URL = "https://careers-aei.icims.com/jobs/search?ss=1"
BASE_URL   = "https://careers-aei.icims.com"
